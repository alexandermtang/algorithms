...
\noindent Mallory was able to figure out this message by using the Chinese Remainder Theorem. This applies in this case because every e in the public keys is 3 which opens a vulnerability in RSA\\
i.e :\\
\indent$q \equiv m \mod x$ \\
\indent$q \equiv n \mod y$ \\
\indent$q \equiv o \mod z$ \\
This is true assuming that x,y and z are relative primes \\ 
