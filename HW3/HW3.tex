...
two sets of coordinates using the distance formula in constant time and a
function \verb|min(a,b)| which returns the minimum between \verb|a| and
\verb|b| in constant time.
